...
export {deleteTournament, getMatches, setMatches, getCurrentRound, checkDatabase, setUsers, addUser, updateUsersScore, onCalculateWeeklyScore, sortUsers, reverseUsers, calculateTotalScore} from './tournament';
